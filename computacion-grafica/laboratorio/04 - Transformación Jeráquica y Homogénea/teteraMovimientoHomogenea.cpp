...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Lab 4: Tetera movimiento homogenea");
...
GLvoid window_display()
{
    ...
    float center[16], orbit[16], offset[16];

    translation(center, positionX, 0.0f, 0.0f);
    rotationZ(orbit, angle);
    translation(offset, 4.0f, 0.0f, 0.0f);

    glPushMatrix();
    glMultMatrixf(center);
    ...
    angle += 140.0f * deltaTime / 1000.0f;
...
GLvoid window_reshape(GLsizei width, GLsizei height)
{
    ...
    glLoadIdentity();
    glOrtho(-14.0f, 14.0f, -12.0f, 12.0f, -25.0f, 25.0f);
    glMatrixMode(GL_MODELVIEW);
}
