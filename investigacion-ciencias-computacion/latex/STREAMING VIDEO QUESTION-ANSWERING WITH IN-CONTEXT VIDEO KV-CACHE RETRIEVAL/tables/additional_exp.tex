...
\centering
\caption{
\textbf{Experimentos adicionales con más Video-LLMs y benchmark.}\\
``Acc.'' denota accuracy.
``X Frames'' se refiere a muestrear uniformemente X frames del video.
``Y FPS $\to$ X Frames'' indica un video de entrada con una tasa de cuadros de Y FPS, del cual se recuperan X frames.
}
