...
\centering
\caption{
\textbf{Video question-answering offline en cuatro benchmarks de formato largo.}
``Acc.'' denota accuracy, y
``Score'' es la calificación de respuestas abiertas realizada por \texttt{gpt-3.5-turbo-0613} en una escala de 1 a 5.
}
\label{tab:sota}
\footnotesize
\resizebox{\linewidth}{!}{
